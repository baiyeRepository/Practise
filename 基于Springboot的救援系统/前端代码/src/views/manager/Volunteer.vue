<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入用户名查询" style="width: 200px" v-model="name"></el-input>
      ...
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="avatar" label="个人照片">
          <template v-slot="scope">
            <el-image v-if="scope.row.avatar" style="width: 50px" :src="scope.row.avatar"
        ...
        <el-table-column prop="info" label="介绍" min-width="200"></el-table-column>
    ...
    <el-dialog title="志愿者信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
